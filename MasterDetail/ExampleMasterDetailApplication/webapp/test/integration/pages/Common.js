sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/uralhalil/org/ExampleMasterDetailApplication/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#ExampleMasterDetailApplication-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#ExampleMasterDetailApplication-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("com.uralhalil.org.ExampleMasterDetailApplication.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/uralhalil/org/ExampleMasterDetailApplication/localService/mockserver"], function (mockserver) {
